...
export default class BoidsController {
     ...
     */
    constructor(boundaryX = 2000, boundaryY = 1000, boundaryZ = 2000, subDivisionCount=1) {
        ...
        this.aligmentWeight = 3.0;
        this.cohesionWeight = 3.4;
        this.separationWeight = 0.3;

        this.maxEntitySpeed = 0.5;

        this.aligmentRadius = 30;
