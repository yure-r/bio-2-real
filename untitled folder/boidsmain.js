...
class Application {
    ...
    init() {
        ...
        this.boidsController = new BoidsController(220, 200, 220, 2);

        // create renderer and pass boidsController to render entities
        this.simpleRenderer = new SimpleRenderer({boidsController: this.boidsController}, scene);
        this.simpleRenderer.init();
      
      
        // console.log(this.simpleRenderer.scene)
